...
export const Joker2SvgComponent = ({ width, height }: SvgCardProps) => (
  <svg
  ...
  >
    ...
    <rect
      ...
      stroke="black"
    ></rect>
    <use width="202.8" height="312" x="-101.4" y="-156" xlinkHref="#J21"></use>
    <use width="202.8" height="312" x="-101.4" y="-156" xlinkHref="#J22"></use>
  </svg>
);
